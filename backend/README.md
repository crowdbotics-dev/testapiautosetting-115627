...
## Project Structure
    ...
    ├── testapiautosetting_115627  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115627`
...
2. Clone this repo and `cd testapiautosetting_115627`
